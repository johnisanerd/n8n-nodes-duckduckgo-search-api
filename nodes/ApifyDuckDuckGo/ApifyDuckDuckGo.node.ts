...
import { properties } from './ApifyDuckDuckGo.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'drYfVwbtEdPqbFkiC' as string;

export const PACKAGE_NAME = 'n8n-nodes-duckduckgo-search-api' as string;
export const CLASS_NAME = 'ApifyDuckDuckGo' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'duckduckgo-search-app' as string;

export const DISPLAY_NAME = 'DuckDuckGo Search' as string;
export const DESCRIPTION =
	'Search DuckDuckGo and return organic results with titles, links, and snippets' as string;

export class ApifyDuckDuckGo implements INodeType {
